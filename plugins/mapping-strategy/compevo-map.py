...
@StrategyFactory.register(
    ('mappingType', 'mapping/compevo-map')
)
class CompevoMapping:
    ...
    def get(self, session: Optional[Dict[str, Any]] = None) -> Dict:
        ...
        mappings = [
            ...
            ('image_file', 'dm:mapTo',
             'http://compevo/ontotrans.emmc.eu/0.1/Image'),
            ('image_scale', 'dm:mapValue',
             'http://compevo/ontotrans.emmc.eu/0.1/Image#scale'),
            ('image_scale_unit', 'dm:mapUnit',
             'http://compevo/ontotrans.emmc.eu/0.1/Image#scale'),
            ]
...
def find(relations, s=None, p=None, o=None):
    ...
    for ss, pp, oo in relations:
        if ((s is None or s == ss) and
            (p is None or p == pp) and
                (o is None or o == oo)):
            return ss, pp, oo
