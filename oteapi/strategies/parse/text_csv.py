...
class DialectFormatting(BaseModel):
    ...
    quoting: QuoteConstants | None = Field(
        None,
        description=(
...
class ReaderConfig(BaseModel):
    ...
    fieldnames: list[str] | None = Field(
        None,
        description=(
...
class CSVParseContent(AttrDict):
    ...
    content: dict[str | None, list[Any]] = Field(
    ...
    def get(self) -> CSVParseContent:
        ...
        with cache.getfile(cache_key) as csvfile_path:
            ...
            with csvfile_path.open(
                ...
                content: dict[str | None, list[Any]] = defaultdict(list)
