...
class MappingConfig(BaseModel):
    ...
    Attributes:
        mappingType: Type of registered mapping strategy. E.g., `mapping/demo`.
        prefixes: List of shortnames that expands to an IRI given as
            local value/IRI-expansion-pairs.
        triples: List of semantic triples given as (subject, predicate, object).
        configuration: Mapping-specific configuration options given as key/value-pairs.
